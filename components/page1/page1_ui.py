...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalWidget.setGeometry(QRect(-14, -10, 985, 320))
        self.verticalWidget.setStyleSheet(u"border: 0;")
        self.chartContainer = QVBoxLayout(self.verticalWidget)
...
"}")
        ...
        self.right_radius_mask = QFrame(self.frame_2)
        self.right_radius_mask.setObjectName(u"right_radius_mask")
        self.right_radius_mask.setGeometry(QRect(204, 50, 37, 75))
        font3 = QFont()
        font3.setStyleStrategy(QFont.PreferAntialias)
        self.right_radius_mask.setFont(font3)
        self.right_radius_mask.setStyleSheet(u"")
        self.right_radius_mask.setFrameShape(QFrame.Shape.StyledPanel)
        self.right_radius_mask.setFrameShadow(QFrame.Shadow.Raised)
        self.left_radius_mask = QFrame(self.frame_2)
        self.left_radius_mask.setObjectName(u"left_radius_mask")
        self.left_radius_mask.setGeometry(QRect(110, 50, 37, 75))
        self.left_radius_mask.setFont(font3)
        self.left_radius_mask.setStyleSheet(u"")
        self.left_radius_mask.setFrameShape(QFrame.Shape.StyledPanel)
        self.left_radius_mask.setFrameShadow(QFrame.Shadow.Raised)
        self.send_vector = QFrame(self.frame_2)
        self.send_vector.setObjectName(u"send_vector")
        self.send_vector.setGeometry(QRect(249, 85, 10, 7))
        self.send_vector.setStyleSheet(u"")
        self.send_vector.setFrameShape(QFrame.Shape.StyledPanel)
        self.send_vector.setFrameShadow(QFrame.Shadow.Raised)
        self.recv_vector = QFrame(self.frame_2)
        self.recv_vector.setObjectName(u"recv_vector")
        self.recv_vector.setGeometry(QRect(89, 86, 11, 7))
        self.recv_vector.setStyleSheet(u"")
        self.recv_vector.setFrameShape(QFrame.Shape.StyledPanel)
        self.recv_vector.setFrameShadow(QFrame.Shadow.Raised)
...
"}")
        ...
        self.menubar.setGeometry(QRect(0, 0, 935, 36))
