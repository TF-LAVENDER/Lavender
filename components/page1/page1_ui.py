...
"}")
        ...
        self.recv_kbs.setGeometry(QRect(0, 70, 81, 20))
        font1 = QFont()
        ...
        self.send_kbs.setGeometry(QRect(270, 70, 71, 20))
        ...
        self.frame_2.setGeometry(QRect(204, 50, 37, 75))
        self.frame_2.setStyleSheet(u"border-image:url(\"images/Union1.png\");\n"
...
"background-color : rgb(255,255,255,0);")
        ...
        self.send_kbs_2 = QLabel(self.groupBox_2)
        self.send_kbs_2.setObjectName(u"send_kbs_2")
        self.send_kbs_2.setGeometry(QRect(270, 90, 71, 20))
        font3 = QFont()
        ...
        self.recv_kbs_2 = QLabel(self.groupBox_2)
        self.recv_kbs_2.setObjectName(u"recv_kbs_2")
        self.recv_kbs_2.setGeometry(QRect(0, 90, 81, 20))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.send_kbs_2.setText(QCoreApplication.translate("MainWindow", u"xx.x KB/s", None))
        self.recv_kbs_2.setText(QCoreApplication.translate("MainWindow", u"xx.x KB/s", None))
